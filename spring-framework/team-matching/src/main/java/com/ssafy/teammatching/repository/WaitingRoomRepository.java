...
public interface WaitingRoomRepository extends JpaRepository<WaitingRoom, Integer> {
    ...
    @Query(value = "SELECT * FROM waiting_room " +
            "WHERE match_date = ?1 " +
            "AND ST_Distance_Sphere(POINT(?3, ?2), POINT(lng, lat)) <= (distance + ?4) " +
    ...
    List<WaitingRoom> getWaitingRoomByFilter1(String matchDate, double lat, double lng, int distance, String minStartTime, String maxStartTime, String sports, String gameType, int point);
    ...
    @Query(value = "SELECT * FROM waiting_room " +
            ...
            "ORDER BY register_time ASC", nativeQuery = true)
    List<WaitingRoom> getWaitingRoomByFilter2(String matchDate, double lat, double lng, int distance, String minStartTime, String maxStartTime, String sports, String gameType, int point);
    ...
    @Query(value = "SELECT * FROM waiting_room " +
            ...
            "ORDER BY register_time ASC", nativeQuery = true)
    List<WaitingRoom> getWaitingRoomByFilter3(String matchDate, double lat, double lng, int distance, String minStartTime, String maxStartTime, String sports, String gameType, int point);
}
