...
public interface WaitingRoomRepository extends JpaRepository<WaitingRoom, Integer> {
    ...
    List<WaitingRoom> getWaitingRoomByFilter(String matchDate, double lat, double lng, int distance, String minStartTime, String maxStartTime, String sports, String gameType, int point);
}
