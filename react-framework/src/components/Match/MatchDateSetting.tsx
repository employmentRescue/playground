...
export function MatchDateSetting({ startDate, clicked, setFilterData }: Iprops) {
    ...
    return (
        <div className="flex flex-col absolute top-[-117px] left-0 w-full h-screen m-0 p-0 z-20">
            ...
            <div className="justify-center pt-10 w-full h-3/5 flex-grow-0 bg-[#fff] z-20">
                ...
                <div className="w-full h-2/3 mt-10 justify-center bg-[#fff]">
                ...
                <div className="h-1/6 justify-center mb-15 mx-13 pt-10">
                    <div className="grid place-content-center h-34 mt-4 w-full text-center bg-[#303eff] rounded-[5px]  font-[15px] text-[#fff]" onClick={(e) => { e.preventDefault(); clicked(); setFilterData("startDate", dayjs(temDate).format('YYYY-MM-DD')) }}>설정 완료</div>
                </div>
            </div>
        </div>
    )
