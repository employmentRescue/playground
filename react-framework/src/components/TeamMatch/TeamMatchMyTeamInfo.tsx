    ...
    return (
        <div className="relative flex w-full h-full m-0 p-0 bg-[#ffffff] rounded-5">
            ...
            <div className="flex flex-col items-center justify-between w-1/3 h-full my-5">
                ...
                <Link to='/team-match/register' className="grid place-content-center h-23 my-15 w-60 text-center bg-[#303eff] rounded-[5px] font-inter text-[12px] text-[#fff] " >경기 등록</Link>
            </div>
        </div>
    )
}