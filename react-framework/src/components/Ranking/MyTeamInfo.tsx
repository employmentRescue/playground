  ...
  return (
    <div className="w-[calc(100%-8px)] h-167 mt-49 ml-4 mr-4 border-t-4 border-blue-700 rounded-5 flex items-center bg-white">
      <div className="w-123 flex flex-col justify-center items-center ml-10">
        ...
        <img className="w-70 h-70" src={getImgUrl('profiles/team', props.isMyTeam ? props.teamRanking.team.teamId : props.teamRanking.teamId)}></img>
      ...
      <div className="flex justify-between">
        ...
        <div className="flex justify-between">
          <div className="w-90 text-17 font-bold text-[#a3adb5]">Win Rate</div><div className="w-63 text-right text-17 font-bold text-blue-700">
            {props.isMyTeam ? ((props.teamRanking.teamStats.win / (props.teamRanking.teamStats.win + props.teamRanking.teamStats.lose)) * 100).toFixed(1) : 
            ((props.teamRanking.win / (props.teamRanking.win + props.teamRanking.lose)) * 100).toFixed(1)} %</div>
        </div>
        <div className="flex justify-between">
