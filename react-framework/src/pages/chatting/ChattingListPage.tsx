...
import autoMatchSoccer from "@/assets/profiles/auto-match-soccer.png"
...
export default function ChattingListPage() {
    return (
        <div className="flex flex-col h-full">
            ...
            <ListCard roomProfile={autoMatchSoccer} title="01-16축구" personnel={22} latestMsg={"매칭이 완료되었습니다!"} />
