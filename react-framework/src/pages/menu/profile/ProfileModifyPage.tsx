...
export default function ProfileModifyPage() {
	...
	const [isFavoritefootball, setIsFavoritefootball] = useState<boolean>(false);
	const [isFavoriteBasketball, setIsFavoriteBasketball] = useState<boolean>(false);
	const [isFavoriteBadminton, setIsFavoriteBadminton] = useState<boolean>(false);
	const [favoriteTime, setFavoriteTime] = useState<number[]>([0, 24]);
		...
		<div>
			<div className="flex flex-col w-full h-auto pt-150 bg-[#EEF3FC] justify-start tracking-tight">
				<div className="flex flex-col bg-white">
					...
					<p className="mt-4 text-16 text-[#969696] text-inter text-center">{userInfo.data?.data.name}</p>
			...
			<div className="flex flex-col mt-8 pl-24 pr-24 w-full h-auto bg-white justify-start">
				...
				<div className="flex justify-between self-center">
					<div className="flex-col">
						<ImageCard
							onClick={() => setIsFavoritefootball(!isFavoritefootball)}
					...
					<div className="flex-col">
						<ImageCard
							onClick={() => setIsFavoriteBasketball(!isFavoriteBasketball)}
					...
					<div className="flex-col">
						<ImageCard
							onClick={() => setIsFavoriteBadminton(!isFavoriteBadminton)}
