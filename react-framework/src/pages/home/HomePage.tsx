	...
	return (
		<div>
			{promisedMatchList.isSuccess && promisedMatchList.data ?
				...
				(
					<SwiperSlide key={index} onClick={() => location.assign(`/gather/detail/${item.gatheringId}`)}>
				...
				<div className="w-full h-55 mt-8 mb-8">
					<div className="flex justify-center	 items-center w-[calc(100%-20px)] ml-auto mr-auto h-55 bg-white rounded-15">
						[참여한 운동 모임이 없습니다]
					</div>
				</div>
			}
