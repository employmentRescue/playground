...
CREATE TABLE `gathering_member` (
  ...
  KEY `fk_gathering_id_idx` (`gathering_id`),
  CONSTRAINT `fk_gathering_member_member_id` FOREIGN KEY (`gathering_id`) REFERENCES `gathering` (`gathering_id`),
  CONSTRAINT `fk_member_gathering_id` FOREIGN KEY (`member_id`) REFERENCES `member_sometimes` (`member_id`)
...
-- Dump completed on 2023-02-17 13:04:51
