...
- ### 3. 개인 매칭
  ...
  - 원하는 거리, 시간 등을 설정하고 버튼 한번으로 간편하게 같이 운동할 사람을 모집할 수 있습니다.
  - 직접 운동 인원을 모집하는 게시글을 올려 같이 운동할 사람의 참여를 유도할 수 있습니다.

- ### 4. 팀 매칭 & 랭킹
  
  - 
  - 내 팀이 얼마나 잘하는지 알고 싶지 않나요? 팀 랭킹을 통해 우리 팀의 순위를 알 수 있습니다.
